...
def slidingWindow(sequence,winSize,step=1):
	...
	for i in range(0,numOfChunks*step,step):
		...
		print vector_update[current_window[2]],"\n"
		print vector_update[current_window[2]][0].__class__
		print "Testing\n\n\n"
		print "Hello there : ", current_window
		...
		while (cnt!=0 and repetition<3) :
			...
			for word_tuple in words:
				if(word_tuple[0]!=current_window[center]):
					...
					#print "W_temp1 has the shape of ",W_temp1.shape
					"""
					...
					#print "W_temp1_sigmoid has the shape of ",W_temp1_sigmoid.shape
					
					#backpropagate_1 = W_temp1
					W_temp1_save = W_temp1
					W_temp1_save_sigmoid = W_temp1_sigmoid
					...
					word_score = W_temp2*W_temp1_save_sigmoid + bias_layer_2
					word_score_shape = word_score
					...
					#print "Hello"
					#print "word_score_shape has the shape of ",word_score_shape.shape,"\n\n"
					...
					if(error):
						...
						#"""
						d_word_score = 1
						#d_W_layer2 = np.multiply(d_word_score,W_temp1_sigmoid.T)  #dZ2.dot(A1.T)
						d_W_layer2 = d_word_score*W_temp1_sigmoid  #dZ2.dot(A1.T)
						#print "d_W_layer2 is ",d_W_layer2
						
						#print "\n\nd_W_layer2 has the shape of ",d_W_layer2.shape
						#print "(W_layer2.T).shape ",(W_layer2.T).shape
						#print "word_score_shape.shape ",word_score_shape.shape
						
						d_W_temp1_sigmoid = W_layer2.T*word_score_shape
						
						#print "d_W_temp1_sigmoid has the shape of ",d_W_temp1_sigmoid.shape
						...
						#dx=np.dot(W1.T,dZ1)
						#d_X = np.multiply(W.T, d_W_temp1_save)
						...
						print "The value of abc_temp__class__ is ",abc_window_temp.__class__
						print "The shape of abc_window_temp is ", abc_window_temp.shape
						print "The shape of d_X is ", d_X.shape
						#print d_X
						abc_window_temp = abc_window_temp + d_X
						for i in xrange(0,3):
							#print i
							#print current_window[i]
							print current_window[i]
							print "Hellooooo"
							print "Vector value for i = ",i," is \t"
							print vector_update[current_window[i]]
							print vector_update[current_window[1]]
							for j in xrange(0,6):
								#vector_update[current_window[i]]
								#print current_window[i]
								#print vector_update[current_window[i]][j]
								vector_update[current_window[i]][j] = vector_update[current_window[i]][j] + d_X[i*6 + j]
								#print vector_update[current_window[i]]
								#print j
								#continue
